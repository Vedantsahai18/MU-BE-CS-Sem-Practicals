/*
    ...
    Mr K has a rectangular land of size . There are marshes in the land where the fence cannot hold. Mr
    K wants you to find the perimeter of the largest rectangular fence that can be built on this land.
    Input format
    The first line contains and . The next lines contain characters each describing the state of the land.
